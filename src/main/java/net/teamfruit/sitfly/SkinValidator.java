...
public class SkinValidator {
    ...
    public static boolean isSimilarColor(Color c, Color a, double limit) {
    ...
    public static boolean validateSkin(BufferedImage image, int color, double limit) {
        ...
        return SkinValidator.isSimilarColor(new Color(colorJacket), new Color(color), limit)
                || SkinValidator.isSimilarColor(new Color(colorBody), new Color(color), limit);
    }
}